...
from clef.baselines.layers.embed import PatchEmbedding, Patching
from clef.baselines.layers.revin import RevIN
from clef.utils.masking import Masking
from clef.utils.moment_utils import (
...
if __name__ == "__main__":
    ...
    # Example input
    x_enc = torch.randn(32, 1, 1000)  # batch_size=32, n_channels=1, seq_len=1000
    input_mask = torch.ones(32, 1000)
